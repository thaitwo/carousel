...
var Carousel = function () {
  function Carousel(_ref) {
    ...
    // IF IMAGE LINKS ARRAY IS NOT GIVEN, SEARCH DOM FOR IMAGES AND CREATE ARRAY OF LINKS
        ...
        this.images = _lodash2.default.map((0, _jquery2.default)('.carousel img'), function (image) {
          return image.src;
        });
      }
    ...
    this.$pause = (0, _jquery2.default)('.pause-autoplay');
  ...
  _createClass(Carousel, [{
    ...
    value: function renderImages() {
      ...
      var images = this.images.map(function (link) {
        return '<img src="' + link + '">';
      });
    ...
    value: function renderBreadcrumbs() {
      ...
      (0, _jquery2.default)(this.$breadcrumbs[0]).addClass('active');
    ...
    value: function activateBreadcrumb() {
      ...
      this.$breadcrumbContainer.on('click', 'li', function (event) {
        ...
        _this.$breadcrumbs.removeClass('active');
        (0, _jquery2.default)(event.target).addClass('active');

        _this.displayImage(_this.images[id]);
      });
    }
    ...
    key: 'displayImage',
    value: function displayImage(link) {
    ...
    value: function activateAutoplay() {
      ...
      this.$pause.hover(function () {
        ...
        autoplay = setInterval(_this3.nextImage.bind(_this3), 4000);
      });
    }
